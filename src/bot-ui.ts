...
const HELP_TOPICS: HelpTopic[] = [
  {
    ...
    lines: [
      ...
      "3. Futtasd: /handback",
      "Alternatíva: /handoff gombos menü.",
      "4. A bot kiír egy cd ... && codex resume <thread-id> parancsot.",
      "A bot emellett helyi handoff-outbox rekordot is ír, hogy az átadás később visszakereshető legyen.",
      "Lépések gépen:",
      ...
      "Célgép megjelöléséhez használd: /handoff_to <host>",
    ],
  },
  {
  ...
  },
  {
    ...
    aliases: ["watchdog", "health", "status", "doctor", "git", "repo", "notes", "commit"],
    lines: [
      "Mire való: megmutatja, hogy a bridge bot fut-e, melyik hostról válaszol, van-e aktív kérés és mi volt az utolsó hiba.",
      "/doctor teljesebb, de read-only állapotképet ad: auth, workspace, git, watchdog.",
      "/git csak az aktuális repo git állapotát mutatja.",
      "/repo megmutatja a workspace-t, a git repo gyökerét és az AGENTS.md láncot.",
      "/notes bot-saját operator jegyzetet ír az AttysCodexBridge .telecodex mappájába.",
      "/commit megerősítéses commit-flow-t indít, de push-t nem végez.",
  ...
  const sections = [
    {
      ...
      commands: [
        ...
        ["/doctor", "Bot, auth, repo és watchdog állapot"],
        ["/git", "Aktuális repo git állapota"],
        ["/repo", "Workspace és AGENTS.md lánc"],
        ["/sessions", "Szálak böngészése és váltása"],
        ["/attach", "Codex szál hozzákötése ehhez a témához"],
        ["/handoff", "Handoff menü"],
        ["/handback", "Szál visszaadása a Codex CLI-nek"],
        ["/handoff_to", "Szál átadása célgépnek"],
        ["/commit", "Biztonságos commit-flow push nélkül"],
